...
function PostCreation({ content, isNew, title, slug, onUpdateContent, onUpdateTitle, addPost, editPost, endPostCreation, history }) {
...
const mapDispatchToProps = dispatch => ({
    onUpdateContent: (content) => dispatch({ type: "UPDATE_CONTENT", payload: content }),
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(PostCreation));
